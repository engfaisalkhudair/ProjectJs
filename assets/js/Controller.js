...
function mainProducts(){
    ...
    let products;
    let productsObjLocal = localStorage.getItem('products');
    if(productsObjLocal){
        products = JSON.parse(productsObjLocal); 
    }else{
...
// window.mainProducts = mainProducts;
console.log(window.addNewItem);
...
function deleteItem(id) {
  let products = JSON.parse(localStorage.getItem("products"));
  let productFind = products.findIndex(obj => obj.id === id);
  products.splice(productFind , id);
  return localStorage.setItem("products", JSON.stringify(products));
}
...
function cartProducts(){
  ...
  if(cartproductsObjLocal){
    ...
    cartproducts.forEach(product => {
      ...
      let footerContent =  document.createElement("div")
      footerContent.classList.add("card-footer");
      footerContent.dataset.productId = product.id;
...
function deleteItemCart(id) {
  let productsCart = JSON.parse(localStorage.getItem("productsCart"));
  let productFindCart = productsCart.findIndex(obj => obj.id === id);
  productsCart.splice(productFindCart , id);
  return localStorage.setItem("productsCart", JSON.stringify(productsCart));
}
